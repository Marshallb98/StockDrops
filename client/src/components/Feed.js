...
import { ListGroup, Accordion, Card, Row, Container } from "react-bootstrap";
            ...
            <Card>
              ...
              <Accordion.Collapse eventKey="1">
                <Card.Body className="cardBody">
                  ...
                  <h5>
                    {" "}
                    For any store that you wish to get an item from it is highly
                    suggested if available to create an account with your
                    payment information and shipping address saved. Remember
                    that there are a huge amount of people trying to get these
                    cards so don't get down if you don't get it on your first
                    try!
                  </h5>
                  <ul>
                    <li>
